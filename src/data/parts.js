...
const HEAD_PARTS = [
  ...
  { id: 'h_rust_visor', name: 'Horizon Visor', tier: 1, stats: { Damage: 5, Speed: 5, Armor: 8, Weight: 8 }, icon: 'View', rarity: RARITY.COMMON },
  { id: 'h_train_helm', name: 'Safety Helm', tier: 1, stats: { Damage: 2, Speed: 8, Armor: 10, Weight: 6 }, icon: 'HardHat', rarity: RARITY.COMMON },
  ...
  { id: 'h_bucket', name: 'Cargo Head', tier: 1, stats: { Damage: 0, Speed: 0, Armor: 15, Weight: 10 }, icon: 'Container', rarity: RARITY.COMMON }, // 'Container' is a box
  ...
  { id: 'h_target_mat', name: 'Crosshair System', tier: 2, stats: { Damage: 12, Speed: 8, Armor: 4, Weight: 7 }, icon: 'Crosshair', rarity: RARITY.UNCOMMON },
  { id: 'h_reinf_helm', name: 'Shielded Helm', tier: 2, stats: { Damage: 5, Speed: 4, Armor: 15, Weight: 14 }, icon: 'Shield', rarity: RARITY.UNCOMMON },
  { id: 'h_sens_array', name: 'Radio Array', tier: 2, stats: { Damage: 6, Speed: 15, Armor: 3, Weight: 9 }, icon: 'Radio', rarity: RARITY.UNCOMMON },
  { id: 'h_night_vis', name: 'Null-Visor', tier: 2, stats: { Damage: 7, Speed: 12, Armor: 4, Weight: 6 }, icon: 'EyeOff', rarity: RARITY.UNCOMMON },
  { id: 'h_comm_link', name: 'Signal Link', tier: 2, stats: { Damage: 4, Speed: 18, Armor: 2, Weight: 5 }, icon: 'Wifi', rarity: RARITY.UNCOMMON },
  { id: 'h_webcam', name: 'Optic Eye', tier: 2, stats: { Damage: 5, Speed: 15, Armor: 2, Weight: 5 }, icon: 'Webcam', rarity: RARITY.UNCOMMON },
  { id: 'h_router', name: 'Router Cowl', tier: 2, stats: { Damage: 8, Speed: 12, Armor: 0, Weight: 6 }, icon: 'Router', rarity: RARITY.UNCOMMON },
  ...
  { id: 'h_mask', name: 'Masquerade', tier: 2, stats: { Damage: 8, Speed: 15, Armor: 5, Weight: 4 }, icon: 'VenetianMask', rarity: RARITY.UNCOMMON },
  ...
  { id: 'h_omni_vis', name: 'Detective Visor', tier: 3, stats: { Damage: 15, Speed: 18, Armor: 12, Weight: 12 }, icon: 'HatGlasses', rarity: RARITY.RARE },
  { id: 'h_ai_assistant', name: 'Droid Head', tier: 3, stats: { Damage: 12, Speed: 30, Armor: 5, Weight: 8 }, icon: 'Bot', rarity: RARITY.RARE },
  { id: 'h_carbon_mask', name: 'Phantom Mask', tier: 3, stats: { Damage: 20, Speed: 15, Armor: 15, Weight: 9 }, icon: 'Ghost', rarity: RARITY.RARE },
  { id: 'h_third_eye', name: 'Delta Visor', tier: 3, stats: { Damage: 25, Speed: 25, Armor: 2, Weight: 5 }, icon: 'Triangle', rarity: RARITY.RARE },
  { id: 'h_telescope', name: 'Astro Scope', tier: 3, stats: { Damage: 30, Speed: 5, Armor: 0, Weight: 12 }, icon: 'Telescope', rarity: RARITY.RARE },
  { id: 'h_micro', name: 'Micro-Sight', tier: 3, stats: { Damage: 15, Speed: 25, Armor: 5, Weight: 8 }, icon: 'Microscope', rarity: RARITY.RARE },
  { id: 'h_queen', name: 'Queen\'s Gambit', tier: 3, stats: { Damage: 25, Speed: 25, Armor: 10, Weight: 10 }, icon: 'ChessQueen', rarity: RARITY.RARE },
  ...
  { id: 'h_neural_net', name: 'Neural Network', tier: 4, stats: { Damage: 25, Speed: 45, Armor: 15, Weight: 8 }, icon: 'Network', rarity: RARITY.EPIC },
  { id: 'h_cyber_demon', name: 'Cyber Specs', tier: 4, stats: { Damage: 45, Speed: 20, Armor: 25, Weight: 18 }, icon: 'RectangleGoggles', rarity: RARITY.EPIC },
  { id: 'h_precalc_core', name: 'Binary Core', tier: 4, stats: { Damage: 30, Speed: 50, Armor: 5, Weight: 10 }, icon: 'Binary', rarity: RARITY.EPIC },
  { id: 'h_titan_helm', name: 'Paladin Helm', tier: 4, stats: { Damage: 10, Speed: 5, Armor: 60, Weight: 40 }, icon: 'ShieldCheck', rarity: RARITY.EPIC },

  // --- TIER 5: LEGENDARY ---
  { id: 'h_oracle_ai', name: 'Oracle Brain', tier: 5, stats: { Damage: 55, Speed: 60, Armor: 30, Weight: 15 }, icon: 'Brain', rarity: RARITY.LEGENDARY },
  ...
  { id: 'h_death_stare', name: 'Sonic Headset', tier: 5, stats: { Damage: 90, Speed: 40, Armor: 10, Weight: 12 }, icon: 'HeadPhones', rarity: RARITY.LEGENDARY }, // Fixed: Was Death Stare
  { id: 'h_medusa', name: 'Medusa Scan', tier: 5, stats: { Damage: 60, Speed: 10, Armor: 30, Weight: 15 }, icon: 'ScanFace', rarity: 'Legendary' },
  { id: 'h_hive_mind', name: 'Hive Mind Node', tier: 5, stats: { Damage: 40, Speed: 50, Armor: 10, Weight: 5 }, icon: 'BrainCircuit', rarity: 'Legendary' },
  { id: 'h_cyclops', name: 'Cyclops Visor', tier: 5, stats: { Damage: 80, Speed: 5, Armor: 20, Weight: 20 }, icon: 'Eye', rarity: 'Legendary' }, 
...
const RIGHT_ARM_PARTS = [
   // --- TIER 1: COMMON ---
  { id: 'ra_pipe', name: 'Steel Hammer', tier: 1, stats: { Damage: 20, Speed: 8, Armor: 2, Weight: 8 }, icon: 'Hammer', rarity: RARITY.COMMON },
  { id: 'ra_drill', name: 'Old Drill', tier: 1, stats: { Damage: 22, Speed: 5, Armor: 4, Weight: 10 }, icon: 'Drill', rarity: RARITY.COMMON },
  { id: 'ra_rivet', name: 'Disc Launcher', tier: 1, stats: { Damage: 18, Speed: 12, Armor: 0, Weight: 6 }, icon: 'Disc', rarity: RARITY.COMMON }, // Fixed: Was Rivet Gun
  ...
  // --- TIER 2: UNCOMMON ---
  { id: 'ra_plasma', name: 'Plasma Shears', tier: 2, stats: { Damage: 22, Speed: 8, Armor: 3, Weight: 12 }, icon: 'Scissors', rarity: RARITY.UNCOMMON }, // Fixed: Scissors
  { id: 'ra_cannon', name: 'Heavy Drop Forge', tier: 2, stats: { Damage: 20, Speed: 12, Armor: 4, Weight: 15 }, icon: 'Anvil', rarity: RARITY.UNCOMMON }, // Fixed: Was Autocannon
  { id: 'ra_shock', name: 'Storm Breaker', tier: 2, stats: { Damage: 25, Speed: 6, Armor: 6, Weight: 14 }, icon: 'CloudOff', rarity: RARITY.UNCOMMON },
  { id: 'ra_laser', name: 'Pylon Lance', tier: 2, stats: { Damage: 24, Speed: 10, Armor: 2, Weight: 10 }, icon: 'UtilityPole', rarity: RARITY.UNCOMMON }, // Fixed: Utility Pole
  { id: 'ra_saw', name: 'Buzzsaw', tier: 2, stats: { Damage: 28, Speed: 5, Armor: 0, Weight: 16 }, icon: 'Slice', rarity: RARITY.UNCOMMON },
  // ... (keeping left arm parts that were accidentally in Right Arm array? I'll remove them to clean up or leave if intentional for dual wielding)
  // NOTE: Your original list had Left Arm parts mixed here. I am removing the LA parts from RA array for cleanliness unless you want them here.
  
  // --- TIER 3: RARE ---
  { id: 'ra_fusion', name: 'Rocket Punch', tier: 3, stats: { Damage: 38, Speed: 10, Armor: 5, Weight: 18 }, icon: 'Rocket', rarity: RARITY.RARE }, // Fixed: Was Fusion Blaster
  { id: 'ra_nano', name: 'Thunder Strike', tier: 3, stats: { Damage: 35, Speed: 18, Armor: 4, Weight: 12 }, icon: 'Bolt', rarity: RARITY.RARE }, // Fixed: Bolt icon
  { id: 'ra_tesla', name: 'Tesla Coil', tier: 3, stats: { Damage: 30, Speed: 15, Armor: 0, Weight: 14 }, icon: 'CloudLightning', rarity: RARITY.RARE },
  { id: 'ra_railgun', name: 'Velocity Dart', tier: 3, stats: { Damage: 45, Speed: 4, Armor: 0, Weight: 25 }, icon: 'ArrowRight', rarity: RARITY.RARE }, // Arrow icon
  { id: 'ra_wand_spark', name: 'Tech Scepter', tier: 3, stats: { Damage: 40, Speed: 15, Armor: 0, Weight: 5 }, icon: 'WandSparkles', rarity: RARITY.RARE },
  { id: 'ra_cross', name: 'Crusader Hilt', tier: 3, stats: { Damage: 50, Speed: 5, Armor: 10, Weight: 15 }, icon: 'Cross', rarity: RARITY.RARE },

  // --- TIER 4: EPIC ---
  { id: 'ra_void_blade', name: 'Severed Link', tier: 4, stats: { Damage: 60, Speed: 25, Armor: 5, Weight: 10 }, icon: 'Unplug', rarity: RARITY.EPIC }, // Fixed: Unplug icon
  { id: 'ra_thermal', name: 'Thermal Pick', tier: 4, stats: { Damage: 55, Speed: 15, Armor: 10, Weight: 20 }, icon: 'Pickaxe', rarity: RARITY.EPIC },
  ...
  { id: 'ra_monowire', name: 'Signal Lash', tier: 4, stats: { Damage: 50, Speed: 40, Armor: 0, Weight: 5 }, icon: 'Rss', rarity: RARITY.EPIC }, // RSS Icon

  // --- TIER 5: LEGENDARY ---
  { id: 'ra_doomsday', name: 'Cherry Bomb', tier: 5, stats: { Damage: 120, Speed: 5, Armor: 15, Weight: 50 }, icon: 'Bomb', rarity: RARITY.LEGENDARY },
  { id: 'ra_mjolnir', name: 'Judge\'s Gavel', tier: 5, stats: { Damage: 100, Speed: 20, Armor: 30, Weight: 60 }, icon: 'Gavel', rarity: RARITY.LEGENDARY },
  { id: 'ra_excalibur', name: 'Data Spike', tier: 5, stats: { Damage: 90, Speed: 50, Armor: 10, Weight: 10 }, icon: 'Usb', rarity: RARITY.LEGENDARY }, // Fixed: USB Icon
  { id: 'ra_reaper', name: 'Frame Breaker', tier: 5, stats: { Damage: 95, Speed: 25, Armor: 0, Weight: 15 }, icon: 'Crop', rarity: 'Legendary' }, // Crop Icon
  ...
  { id: 'ra_cryo_beam', name: 'Absolute Zero', tier: 5, stats: { Damage: 70, Speed: 15, Armor: 30, Weight: 25 }, icon: 'Snowflake', rarity: 'Legendary' }, 
  { id: 'ra_sonic', name: 'Bass Cannon', tier: 5, stats: { Damage: 80, Speed: 40, Armor: 0, Weight: 30 }, icon: 'Speaker', rarity: 'Legendary' },
  { id: 'ra_drill_giga', name: 'Mega Ratchet', tier: 5, stats: { Damage: 100, Speed: 5, Armor: 30, Weight: 50 }, icon: 'Ratchet', rarity: 'Legendary' }, 
...
const LEFT_ARM_PARTS = [
  ...
  { id: 'la_welder', name: 'Laser Stylus', tier: 1, stats: { Damage: 12, Speed: 8, Armor: 12, Weight: 9 }, icon: 'PenTool', rarity: RARITY.COMMON }, // Fixed: Pen Tool
  ...
  { id: 'la_emp', name: 'Data Log Shield', tier: 2, stats: { Damage: 10, Speed: 15, Armor: 10, Weight: 11 }, icon: 'NotepadTextDashed', rarity: RARITY.UNCOMMON }, // Fixed: Notepad
  ...
  { id: 'la_diamond', name: 'Diamond Barrier', tier: 3, stats: { Damage: 10, Speed: 15, Armor: 40, Weight: 10 }, icon: 'Diamond', rarity: RARITY.RARE },
  ...
  // --- TIER 4: EPIC ---
  { id: 'la_void_shield', name: 'Guardian Shield', tier: 4, stats: { Damage: 15, Speed: 10, Armor: 55, Weight: 25 }, icon: 'ShieldUser', rarity: RARITY.EPIC },
  ...
  { id: 'la_missile', name: 'Cluster Pod', tier: 4, stats: { Damage: 45, Speed: 20, Armor: 5, Weight: 15 }, icon: 'LayoutGrid', rarity: RARITY.EPIC },

  // --- TIER 5: LEGENDARY ---
  { id: 'la_absolute', name: 'Lockdown Plate', tier: 5, stats: { Damage: 20, Speed: 15, Armor: 85, Weight: 35 }, icon: 'Lock', rarity: RARITY.LEGENDARY },
  { id: 'la_reflector', name: 'Expansion Shield', tier: 5, stats: { Damage: 50, Speed: 40, Armor: 40, Weight: 20 }, icon: 'Scaling', rarity: RARITY.LEGENDARY },
  { id: 'la_aegis_prime', name: 'Aegis Prime', tier: 5, stats: { Damage: 20, Speed: 10, Armor: 90, Weight: 40 }, icon: 'ShieldCheck', rarity: 'Legendary' },
  { id: 'la_mirror', name: 'Mirror Force', tier: 5, stats: { Damage: 50, Speed: 30, Armor: 40, Weight: 15 }, icon: 'Minimize', rarity: 'Legendary' },
  ...
  { id: 'la_bio_shield', name: 'Helix Guard', tier: 5, stats: { Damage: 10, Speed: 20, Armor: 60, Weight: 20 }, icon: 'Dna', rarity: 'Legendary' },
  ...
  { id: 'la_infinity', name: 'The Hand', tier: 7, stats: { Damage: 250, Speed: 250, Armor: 250, Weight: 50 }, icon: 'Hand', rarity: RARITY.MYTHIC }
];
...
const CHASSIS_PARTS = [
  ...
  { id: 'ch_hover', name: 'Buoyancy Drive', tier: 2, stats: { Damage: 5, Speed: 20, Armor: 10, Weight: 15 }, icon: 'LifeBuoy', rarity: RARITY.UNCOMMON }, // Fixed: Buoy icon
  { id: 'ch_treads', name: 'Flow Chassis', tier: 2, stats: { Damage: 8, Speed: 4, Armor: 30, Weight: 35 }, icon: 'WrapText', rarity: RARITY.UNCOMMON },
  { id: 'ch_stealth', name: 'Incognito Hull', tier: 2, stats: { Damage: 12, Speed: 15, Armor: 12, Weight: 14 }, icon: 'HatGlasses', rarity: RARITY.UNCOMMON },
  { id: 'ch_pyramid', name: 'Pyramid Base', tier: 2, stats: { Damage: 10, Speed: 5, Armor: 30, Weight: 30 }, icon: 'Pyramid', rarity: RARITY.UNCOMMON },
  { id: 'ch_cube', name: 'Weighted Cube', tier: 2, stats: { Damage: 5, Speed: 5, Armor: 40, Weight: 35 }, icon: 'Cuboid', rarity: RARITY.UNCOMMON },
  { id: 'ch_worm', name: 'Worm Gear', tier: 2, stats: { Damage: 8, Speed: 18, Armor: 15, Weight: 15 }, icon: 'Worm', rarity: RARITY.UNCOMMON },
  ...
  { id: 'ch_maglev', name: 'Surveillance Base', tier: 4, stats: { Damage: 15, Speed: 60, Armor: 20, Weight: 10 }, icon: 'Cctv', rarity: RARITY.EPIC },
  { id: 'ch_fortress', name: 'Flying Fortress', tier: 4, stats: { Damage: 40, Speed: 5, Armor: 80, Weight: 80 }, icon: 'Castle', rarity: RARITY.EPIC },
  { id: 'ch_biomass', name: 'Pulse Frame', tier: 4, stats: { Damage: 25, Speed: 25, Armor: 60, Weight: 40 }, icon: 'Activity', rarity: RARITY.EPIC },

  // --- TIER 5: LEGENDARY ---
  { id: 'ch_dark_matter', name: 'Camcorder Hull', tier: 5, stats: { Damage: 50, Speed: 50, Armor: 50, Weight: 30 }, icon: 'Video', rarity: RARITY.LEGENDARY },
  { id: 'ch_juggernaut', name: 'Blockade Runner', tier: 5, stats: { Damage: 60, Speed: 10, Armor: 120, Weight: 100 }, icon: 'ShieldX', rarity: RARITY.LEGENDARY },
  ...
  // --- TIER 6: OMEGA ---
  { id: 'ch_neutron', name: 'Dish Array', tier: 6, stats: { Damage: 100, Speed: 10, Armor: 200, Weight: 200 }, icon: 'SatelliteDish', rarity: RARITY.OMEGA },
  { id: 'ch_quantum', name: 'Orbital Station', tier: 6, stats: { Damage: 80, Speed: 120, Armor: 60, Weight: 0 }, icon: 'Satellite', rarity: RARITY.OMEGA },

  // --- TIER 7: MYTHIC ---
  { id: 'ch_creator', name: 'The Uplink', tier: 7, stats: { Damage: 200, Speed: 200, Armor: 200, Weight: 50 }, icon: 'Cable', rarity: RARITY.MYTHIC },
