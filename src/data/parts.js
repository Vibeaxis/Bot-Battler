...
const HEAD_PARTS = [
  ...
  { id: 'h_rust_visor', name: 'Rusted Visor', tier: 1, stats: { Damage: 5, Speed: 5, Armor: 8, Weight: 8 }, icon: 'Eye', rarity: RARITY.COMMON },
  ...
  { id: 'h_omni_vis', name: 'Omni-Visor', tier: 3, stats: { Damage: 15, Speed: 18, Armor: 12, Weight: 12 }, icon: 'Eye', rarity: RARITY.RARE },
  ...
  { id: 'h_cyber_demon', name: 'Cyber Demon Mask', tier: 4, stats: { Damage: 45, Speed: 20, Armor: 25, Weight: 18 }, icon: 'Skull', rarity: RARITY.EPIC },
  ...
  { id: 'h_death_stare', name: 'Death Stare', tier: 5, stats: { Damage: 90, Speed: 40, Armor: 10, Weight: 12 }, icon: 'Skull', rarity: RARITY.LEGENDARY },
...
const RIGHT_ARM_PARTS = [
  ...
  { id: 'ra_drill', name: 'Old Drill', tier: 1, stats: { Damage: 22, Speed: 5, Armor: 4, Weight: 10 }, icon: 'Zap', rarity: RARITY.COMMON },
  ...
  { id: 'ra_cannon', name: 'Autocannon', tier: 2, stats: { Damage: 20, Speed: 12, Armor: 4, Weight: 15 }, icon: 'GanttChart', rarity: RARITY.UNCOMMON },
  { id: 'ra_shock', name: 'Shock Fist', tier: 2, stats: { Damage: 25, Speed: 6, Armor: 6, Weight: 14 }, icon: 'Zap', rarity: RARITY.UNCOMMON },
  { id: 'ra_laser', name: 'Laser Lance', tier: 2, stats: { Damage: 24, Speed: 10, Armor: 2, Weight: 10 }, icon: 'Sword', rarity: RARITY.UNCOMMON },
  { id: 'ra_saw', name: 'Buzzsaw', tier: 2, stats: { Damage: 28, Speed: 5, Armor: 0, Weight: 16 }, icon: 'Settings', rarity: RARITY.UNCOMMON },

  // --- TIER 3: RARE ---
  { id: 'ra_fusion', name: 'Fusion Blaster', tier: 3, stats: { Damage: 38, Speed: 10, Armor: 5, Weight: 18 }, icon: 'Rocket', rarity: RARITY.RARE },
  { id: 'ra_nano', name: 'Nano Blade', tier: 3, stats: { Damage: 35, Speed: 18, Armor: 4, Weight: 12 }, icon: 'Feather', rarity: RARITY.RARE },
  { id: 'ra_tesla', name: 'Tesla Coil', tier: 3, stats: { Damage: 30, Speed: 15, Armor: 0, Weight: 14 }, icon: 'Zap', rarity: RARITY.RARE },
  { id: 'ra_railgun', name: 'Mini Railgun', tier: 3, stats: { Damage: 45, Speed: 4, Armor: 0, Weight: 25 }, icon: 'ArrowRight', rarity: RARITY.RARE },

  // --- TIER 4: EPIC ---
  { id: 'ra_void_blade', name: 'Void Blade', tier: 4, stats: { Damage: 60, Speed: 25, Armor: 5, Weight: 10 }, icon: 'Sword', rarity: RARITY.EPIC },
  { id: 'ra_thermal', name: 'Thermal Lance', tier: 4, stats: { Damage: 55, Speed: 15, Armor: 10, Weight: 20 }, icon: 'Flame', rarity: RARITY.EPIC },
  ...
  { id: 'ra_monowire', name: 'Monowire Whip', tier: 4, stats: { Damage: 50, Speed: 40, Armor: 0, Weight: 5 }, icon: 'Waves', rarity: RARITY.EPIC },

  // --- TIER 5: LEGENDARY ---
  { id: 'ra_doomsday', name: 'Doomsday Cannon', tier: 5, stats: { Damage: 120, Speed: 5, Armor: 15, Weight: 50 }, icon: 'Bomb', rarity: RARITY.LEGENDARY },
  { id: 'ra_mjolnir', name: 'Hammer of Thor', tier: 5, stats: { Damage: 100, Speed: 20, Armor: 30, Weight: 60 }, icon: 'Hammer', rarity: RARITY.LEGENDARY },
  { id: 'ra_excalibur', name: 'Photon Saber', tier: 5, stats: { Damage: 90, Speed: 50, Armor: 10, Weight: 10 }, icon: 'Sword', rarity: RARITY.LEGENDARY },
  ...
  // --- TIER 7: MYTHIC ---
  { id: 'ra_god_slayer', name: 'GOD SLAYER', tier: 7, stats: { Damage: 500, Speed: 50, Armor: 0, Weight: 0 }, icon: 'Skull', rarity: RARITY.MYTHIC },
  { id: 'ra_delete_key', name: 'FORMAT C://', tier: 7, stats: { Damage: 999, Speed: 1, Armor: 0, Weight: 999 }, icon: 'Trash', rarity: RARITY.MYTHIC }
];
...
const LEFT_ARM_PARTS = [
  ...
  { id: 'la_buckler', name: 'Scrap Buckler', tier: 1, stats: { Damage: 5, Speed: 6, Armor: 25, Weight: 8 }, icon: 'Shield', rarity: RARITY.COMMON },
  ...
  { id: 'la_emp', name: 'EMP Emitter', tier: 2, stats: { Damage: 10, Speed: 15, Armor: 10, Weight: 11 }, icon: 'Wifi', rarity: RARITY.UNCOMMON },
  ...
  // --- TIER 4: EPIC ---
  { id: 'la_void_shield', name: 'Void Shield', tier: 4, stats: { Damage: 15, Speed: 10, Armor: 55, Weight: 25 }, icon: 'Shield', rarity: RARITY.EPIC },
  { id: 'la_grav_well', name: 'Gravity Well', tier: 4, stats: { Damage: 30, Speed: 5, Armor: 20, Weight: 40 }, icon: 'Orbit', rarity: RARITY.EPIC },
  { id: 'la_phase_shift', name: 'Phase Shifter', tier: 4, stats: { Damage: 10, Speed: 50, Armor: 10, Weight: 5 }, icon: 'Ghost', rarity: RARITY.EPIC },
  ...
  // --- TIER 6: OMEGA ---
  { id: 'la_star_shield', name: 'Star Shield', tier: 6, stats: { Damage: 30, Speed: 20, Armor: 150, Weight: 50 }, icon: 'Sun', rarity: RARITY.OMEGA },
...
const CHASSIS_PARTS = [
  ...
  { id: 'ch_hover', name: 'Hover Drive', tier: 2, stats: { Damage: 5, Speed: 20, Armor: 10, Weight: 15 }, icon: 'Wind', rarity: RARITY.UNCOMMON },
  { id: 'ch_treads', name: 'Tank Treads', tier: 2, stats: { Damage: 8, Speed: 4, Armor: 30, Weight: 35 }, icon: 'WrapText', rarity: RARITY.UNCOMMON },
  { id: 'ch_stealth', name: 'Stealth Hull', tier: 2, stats: { Damage: 12, Speed: 15, Armor: 12, Weight: 14 }, icon: 'Ghost', rarity: RARITY.UNCOMMON },
  ...
  { id: 'ch_maglev', name: 'Maglev Base', tier: 4, stats: { Damage: 15, Speed: 60, Armor: 20, Weight: 10 }, icon: 'Zap', rarity: RARITY.EPIC },
  ...
  // --- TIER 5: LEGENDARY ---
  { id: 'ch_dark_matter', name: 'Dark Matter Engine', tier: 5, stats: { Damage: 50, Speed: 50, Armor: 50, Weight: 30 }, icon: 'Orbit', rarity: RARITY.LEGENDARY },
  { id: 'ch_juggernaut', name: 'Juggernaut Prime', tier: 5, stats: { Damage: 60, Speed: 10, Armor: 120, Weight: 100 }, icon: 'Shield', rarity: RARITY.LEGENDARY },
  { id: 'ch_flash', name: 'Flash Drive', tier: 5, stats: { Damage: 40, Speed: 100, Armor: 20, Weight: 5 }, icon: 'Zap', rarity: RARITY.LEGENDARY },

  // --- TIER 6: OMEGA ---
  { id: 'ch_neutron', name: 'Neutron Star', tier: 6, stats: { Damage: 100, Speed: 10, Armor: 200, Weight: 200 }, icon: 'Disc', rarity: RARITY.OMEGA },
  { id: 'ch_quantum', name: 'Quantum Foam', tier: 6, stats: { Damage: 80, Speed: 120, Armor: 60, Weight: 0 }, icon: 'Cloud', rarity: RARITY.OMEGA },

  // --- TIER 7: MYTHIC ---
  { id: 'ch_creator', name: 'THE ARCHITECT', tier: 7, stats: { Damage: 200, Speed: 200, Armor: 200, Weight: 50 }, icon: 'Database', rarity: RARITY.MYTHIC },
  { id: 'ch_glitch', name: 'MISSING_NO', tier: 7, stats: { Damage: 999, Speed: 999, Armor: 0, Weight: 0 }, icon: 'FileQuestion', rarity: RARITY.MYTHIC }
];
