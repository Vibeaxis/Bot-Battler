      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="w-full md:w-[45%] flex flex-col gap-1">
          ...
          <div className="h-6 bg-gray-800 rounded-sm overflow-hidden border border-gray-700 relative skew-x-[-10deg]">
            ...
            {/* GHOST BAR: This stays white and catches up slowly */}
            <motion.div
            ...
            {/* MAIN BAR: This moves instantly to the new value */}
            <motion.div
        ...
        <div className="flex flex-col items-center justify-center w-full md:w-[10%]">
          <div 
            ...
            style={{ backgroundImage: 'linear-gradient(to right, var(--accent-color), white, #ef4444)' }}
          >
            VS
          </div>
        ...
        <div className="w-full md:w-[45%] flex flex-col gap-1">
          ...
          <div className="h-6 bg-gray-800 rounded-sm overflow-hidden border border-gray-700 relative skew-x-[10deg]">
            ...
            {/* GHOST BAR: For the enemy */}
            <motion.div
              className="absolute inset-y-0 right-0 bg-white/20 z-0"
              initial={false}
            ...
            {/* MAIN BAR */}
            <motion.div
              className="h-full bg-red-600 relative float-right z-10"
              initial={{ width: '100%' }}
              animate={{ width: `${Math.max(0, enemyHealthPercent)}%` }}
              transition={{ type: "spring", stiffness: 100, damping: 20 }}
            >
