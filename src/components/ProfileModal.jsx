...
import { X, Plus, Cpu, Trophy, Crosshair, TrendingUp, Wallet } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[5000] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="relative w-full max-w-6xl h-[90vh] flex flex-col bg-[#0a0a12] border border-[var(--accent-color)] shadow-[0_0_50px_rgba(0,0,0,0.5)] z-[5001] overflow-hidden"
          >
            {/* --- HEADER --- */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-black/20 border-b border-gray-800">
            ...
            <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
              <h3 className="text-gray-500 text-xs font-mono uppercase tracking-widest mb-4 border-b border-gray-800 pb-2">
            ...
            <div className="bg-black/80 border-t border-gray-800 p-4 px-8 flex justify-between items-center text-xs font-mono text-gray-500 uppercase">
              <span>Inventory shared across fleet</span>
